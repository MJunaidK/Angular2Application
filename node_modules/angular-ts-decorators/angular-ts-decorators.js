...
var PlatformRef = /** @class */ (function () {
    ...
    PlatformRef.bootstrapModule = function (moduleType, compilerOptions) {
        ...
        element(document).ready(function () {
            bootstrap('body', [moduleName], { strictDi: strictDi });
        });
    };
    return PlatformRef;
}());
...
export { platformBrowserDynamic, Component, Directive, Injectable, Pipe, Input, Output, NgModule, HostListener, getTypeName, ngLifecycleHooksMap, Type, isType };
